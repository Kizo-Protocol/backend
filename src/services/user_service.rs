...
use crate::models::{User, UserWithBets, UserBetInfo, UserBetMarketInfo, BetCount};
...
impl UserService {
    ...
    pub async fn update_profile(
        ...
        let mut query = String::from(
            r#"UPDATE users SET "updatedAt" = NOW()"#
        );
    ...
    pub async fn get_user_with_bets(&self, user_id: &str) -> Result<UserWithBets, AppError> {
        ...
        let bets = sqlx::query_as::<_, (String, String, bool, String, String, Option<String>, String, chrono::NaiveDateTime, String, String, String, String, Option<String>)>(
            r#"
            SELECT 
                be.id,
        ...
        let user_bets: Vec<UserBetInfo> = bets
            .into_iter()
            .map(|(id, market_id, position, amount_str, odds, payout, status, created_at, _, adj_ticker, question, market_status, image_url)| {
                
                let amount_apt = amount_str.parse::<f64>()
